...
if __name__ == '__main__':
    ...
    gans = [
        ...
        lambda: PACGAN(models.cifar10_dcgan_generator_model(z_dim=z_dim),
                       models.cifar10_dcgan_discriminator_model(image_input_shape=(32, 32, 3 * 2)), name='PACGAN2',
                       pack_nr=2),
    ...
    for gan_f in gans:
        ...
        for i in range(n_rep):
            ...
            gan.train(x, batch_size=batch_size, steps=5, save_samples_every=-1, log_losses=False,
                      logdir='out_CIFAR100') # init TF graph
